...
<body>
    ...
    <main>
        <div class="container">
            ...
            <h6 class="big">Vous souhaitez créer un profil ?</h6>
            <div class="bloc white_b blue">
                <a href="<?= base_url("profil/new") ?>" class="container_bloc one_line_bloc l_r blue">
                    <div class="left">
                    <i class='uil uil-plus-circle'></i>
                    <p class="title">Créer un profil</p>
                    </div>
                    <div class="right">
            ...
            <h6 class="big">Liste des profils</h6>
            ...
            <div class="bloc white_b">
                <a href="<?= base_url("profil/edit/".$profil->id) ?>" class="container_bloc one_line_bloc l_r black">
                    <div class="left">
